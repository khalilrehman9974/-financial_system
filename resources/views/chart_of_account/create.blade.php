                                            ...
                                            <div class="col-lg-6 col-12 ">
                                                <form method="post" action={{ route('chart-of-account.save') }}>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="account-code" type="text" name="account_code"
                                                            placeholder="Enter account code" class="form-control"
                                                            maxlength="3" required>
                                                        <label>Account Name</label>
                                                        <input id="account-name" type="text" name="account_name"
                                            ...
                                            <div class="col-lg-6 col-12 ">
                                                <form method="post">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="t-text" type="text" name="txt"
                                                            placeholder="Enter first level" class="form-control"
                                                            required>

                                                        <input type="submit" name="txt" value="Save"
                                                            class="mt-4 btn btn-primary">
                                                    </div>
                                                </form>
                                            </div>
